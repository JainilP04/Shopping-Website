...
from thelittlethings import settings
from thelittlethings.settings import razorpay_id
...
def razorpaycheck(request):
	...
	return JsonResponse({'add':add, 'cart_items':cart_items, 'totalcost':totalamount})
